    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      <header className="sticky top-0 z-50 border-b border-slate-800 bg-slate-950/95 backdrop-blur">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-white">AQI Prediction</h1>
              <p className="text-xs text-slate-400">Air Quality Intelligence Dashboard</p>
            </div>
          </div>
          <a
      ...
      <main className="container mx-auto px-4 py-8">
        <Tabs defaultValue="predict" className="w-full">
          <TabsList className="grid w-full grid-cols-2 lg:grid-cols-3 bg-slate-800/50 border border-slate-700 p-1 rounded-lg mb-8">
            <TabsTrigger value="predict" className="text-slate-300 data-[state=active]:bg-slate-900">
              Prediction Engine
            </TabsTrigger>
            <TabsTrigger value="analysis" className="text-slate-300 data-[state=active]:bg-slate-900">
              Analysis
            </TabsTrigger>
            <TabsTrigger value="data" className="text-slate-300 data-[state=active]:bg-slate-900 col-span-2 lg:col-span-1">
              Dataset Upload
            </TabsTrigger>
          </TabsList>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2">
                {datasetAnalysis ? (
                  ...
                  <div className="flex items-center justify-center h-96 rounded-lg border border-slate-700 bg-slate-900/50">
                    <div className="text-center">
                      <AlertCircle className="w-8 h-8 text-slate-500 mx-auto mb-2" />
                      <p className="text-slate-400">Upload a CSV dataset to see analysis</p>
                    </div>
                  </div>
                )}
              </div>
      ...
      <footer className="border-t border-slate-800 bg-slate-950/50 mt-16">
        <div className="container mx-auto px-4 py-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              <h3 className="font-semibold text-white mb-4">About AQI</h3>
